...
export interface Monday5 {
    start: string
    end: string
    lastBookedFor: number
}

export interface Tuesday5 {
    start: string
    end: string
    lastBookedFor: number
}

export interface Wednesday5 {
    start: string
    end: string
    lastBookedFor: number
}

export interface Thursday5 {
    start: string
    end: string
    lastBookedFor: number
}

export interface Friday5 {
    start: string
    end: string
    lastBookedFor: number
}

export interface Saturday5 {
    start: string
    end: string
    lastBookedFor: number
}

export interface Sunday5 {
    start: string
    end: string
    lastBookedFor: number
}
